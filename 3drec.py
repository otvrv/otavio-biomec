...
# COORDENADAS CARTESIANAS PARA ESFERICAS
def cart2sph(x,y,z):
...
if __name__ == '__main__':
    ...
    print('Otavio R Vieira - 14748622'.center(58))
    print('Como executar:\n python 3drec.py c1.txt c2.txt c1cal.txt c2cal.txt calibrador_ref.txt nome_que_deseja_salvar'.center(58))
    print(58*'#')
    print('\n')

    # DEFININDO OS PARAMETROS DAS CAMERAS DO EXPERIMENTO
    resolutionx = int(720/2) 
    resolutiony = int(220/2) 
    freq = 120 
    
    # CARREGANDO DAS CAMERAS
    # CAMERA 1
    ...
    # CARREGAR AQUIVOS DE CALIBRACAO
